    ...
    return (
        <section className=" flex flex-col items-center justify-center mt-32">
            ...
            <div className="md:w-[80%] lg:w-[90%] w-[90%] h-[100%] bg-[#C8C6AF] my-10 md:p-20 lg:p-20 p-3 text-center text-[#1C4233]" >
                ...
                <p className="md:text-3xl lg:text-3xl text-xl md:px-32 lg:px-32 px-3 font-semibold leading-loose pt-5 pb-32">حيث يمكنك الاستمتاع بتجربة نكهات بلا مثيل يقوم طهاتنا
            ...
            <img src="/images/about-mid.png" className="hidden md:block w-52 absolute left-10 top-64 " alt="" />
            <img src="/images/about-mid.png" className="hidden md:block w-52 absolute right-10 top-96" alt="" />
